    ...
    <div className="flex justify-center">
        <div className="w-full md:w-2/3 lg:w-1/2">
            <div className="card bg-white shadow-lg rounded-lg">
                <h4 className="card-header bg-gray-800 text-white text-lg font-semibold py-3 px-4 rounded-t-lg">Login</h4>
                <div className="card-body p-4">
                    {data ? (
                        ...
                        <form onSubmit={handleFormSubmit}>
                            ...
                            <button
                                className="btn bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-full"
                                type="submit"
                            >
                                Submit
                            </button>
                            <div className="flex justify-center mt-2">
                                <Link to="/signup" className="text-center text-blue-600 hover:text-blue-800">Signup</Link>
                            </div>
                        </form>
                    )}
